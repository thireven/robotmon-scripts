...
var Logs: StringMap = {
  ...
  beastNoBoard: '[Formal Beast] No gauge on screen, so the skill did not fire; skipping,',
  beastReady: '[Formal Beast] Gauge up, board playable',
  beastTipped: '[Formal Beast] Tipping a gauge, gauges at',
  beastStalled: '[Formal Beast] Nothing linkable, leaving the skill early',
  beastEnded: '[Formal Beast] Window over,',
...
var LogsTW: StringMap = {
  ...
  beastNoBoard: '[正裝野獸] 畫面沒有技能量表，技能未發動；略過，',
  beastReady: '[正裝野獸] 量表出現，畫面可連線',
  beastTipped: '[正裝野獸] 觸發滿槽，量表',
  beastStalled: '[正裝野獸] 沒有可連接的 Tsum，提早結束技能',
  beastEnded: '[正裝野獸] 技能時間結束，',
  gameStart: '遊戲開始',
  gaming: '遊戲中 (慢速版)',
  fastGaming: '遊戲中 (快速版)',
  gameOver: '遊戲結束',
